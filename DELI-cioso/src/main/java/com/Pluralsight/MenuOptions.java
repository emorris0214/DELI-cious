...
public class MenuOptions {
    ...
    public static final List<String> MEATS = Arrays.asList("Turkey", "Ham", "Roast Beef", "Chicken");
    public static final List<String> CHEESES = Arrays.asList("American", "Swiss", "Cheddar", "Provolone");

    public static final List<String> TOPPINGS = Arrays.asList("Lettuce", "Tomato", "Onion", "Pickles", "Olives", "Peppers");
    public static final List<String> SAUCES = Arrays.asList("Mayo", "Mustard", "Ranch", "Oil", "Vinegar");
